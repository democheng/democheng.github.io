...
这里的路径规划定义为：已知路网，给定起点和终点，<img style="float: right;" src="http://chart.googleapis.com/chart?cht=tx&chl=\Large x=\frac{-b\pm\sqrt{b^2-4ac}}{2a}" style="border:none;">选择最合适的一条路径 
